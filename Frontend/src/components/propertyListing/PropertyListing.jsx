...
import propertiesDetailsSlice from '../../store/PropertyDetails/propertyDetails-slice';
const PropertyListing = () => {
  ...
  if(loading || !propertiesDetails)
    return(<div className='row justify-content-around mt-5'><LoadingSpinner/></div>)
  const{propertyName, address, description, images, amenities, maximumGuest, price, currentBookings} = propertiesDetails;
  return (
